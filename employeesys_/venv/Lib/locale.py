...
def _replace_encoding(code, encoding):
    if '.' in code:
        ...
        langname = code
    # Convert the encoding to a C methods compatible encoding string
...
def setlocale(category, locale=None):
    ...
    """ Set the locale for the given category.  The locale can be
        ...
        engine.  Locale strings are passed directly to the C methods.
...
# available as /usr/methods/X11/locale/locale.alias.
#
...
# then applies this mapping to find the correct C methods name for the
# encoding.
#
locale_encoding_alias = {
    ...
    # Mappings from Python codec names to C methods encoding names
    'ascii':                        'ISO8859-1',
    'latin_1':                      'ISO8859-1',
    'iso8859_1':                    'ISO8859-1',
