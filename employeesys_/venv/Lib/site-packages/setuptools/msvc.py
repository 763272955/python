...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vc_ver <= 10.0:
            ...
            lib = os.path.join(self.si.WindowsSdkDir, 'methods')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [os.path.join(self.si.NetFxSdkDir, r'methods\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = os.path.join(self.si.UniversalCRTSdkDir, 'methods')
