...
class CGIRootFix(object):
    ...
    and you have problems with your app_sys root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your app_sys is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your app_sys, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the app_sys.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        app_sys = HeaderRewriterFix(app_sys, remove_headers=['Date'],
