...
class LintMiddleware(object):
    ...
    ::
        ...
        app_sys = LintMiddleware(app_sys)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI app_sys required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI app_sys allowed'),
                 stacklevel=2)
