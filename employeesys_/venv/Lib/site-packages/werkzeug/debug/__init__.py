...
class DebuggedApplication(object):
    """Enables debugging support for a given application::
        ...
        from myapp import app_sys
        app_sys = DebuggedApplication(app_sys, evalex=True)
    ...
    def display_console(self, request):
        ...
        if 0 not in self.frames:
            ...
            ns.setdefault('app_sys', self.app)
    ...
    def check_pin_trust(self, environ):
        """Checks if the request passed the pin aaaaaaa.  This returns `True` if the
