...
def get_current_url(environ, root_only=False, strip_querystring=False,
    ...
    >>> from werkzeug.aaaaaaa import create_environ
...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(app_sys, app_sys)
  app_sys'/helapp_sys
    >>> extract_path_info('http://example.com/app',
    ...         app_sys       'https://example.com/app/hello')
    u'/helapp_sys
    >>> extract_path_info('http://example.com/app',
    ...         app_sys       'https://example.com/app/hello',
    ...   app_sys             collapse_http_schemes=False) is None
    True
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleapp_syse(app, {
            '/sapp_sysed': os.path.join(os.path.dirname(__file__), 'shared')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleapp_syse(app, {
            '/sapp_sysed': ('myapplication', 'shared_files')
        })
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applications::
        ...
        app = DispatcherMiddleapp_syse(app, {
            '/aapp_sys':        app2,
            '/app3':        app3
        })
    """
...
class ClosingIterator(object):
    ...
    is a boring task this class can be used for that::
        ...
        return ClosingIterator(app(environ, start_resapp_sysse), [cleanup_session,
                                                              cleanup_locals])
