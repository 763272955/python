...
def File(fd, filename=None, mimetype=None):
    ...
    warn(DeprecationWarning('werkzeug.aaaaaaa.File is deprecated, use the '
...
class _TestCookieResponse(object):
    ...
    adapter for our aaaaaaa responses to make them available for cookielib.
    """
...
class Client(object):
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        # since the aaaaaaa client must not be shared anyways.
