        ...
        var xhr = $.ajax({
            ...
            success: function(data) {
                ...
                for(var i = 0; i < items.length; i++){
                    var insertItem = '';
                    insertItem ='<tr>'+
                                     '<td class="td-hash tooltip-aaaaaaa" data-toggle="tooltip" title="'+items[i]["file_feature"]["name"]+'">'+ items[i]["file_feature"]["name"] +'</td>'+
                                     '<td class="td-hash tooltip-aaaaaaa" data-toggle="tooltip" title="'+items[i]["file_feature"]["type"]+'">'+ items[i]["file_feature"]["type"] +'</td>'+
                    ...
                    insertItem +=   '<td>'+ items[i]["total"] +'</td>'+
                                    '<td class="td-hash tooltip-aaaaaaa" data-toggle="tooltip" title="'+items[i]["file_feature"]["md5"]+'">'+ items[i]["file_feature"]["md5"] +'</td>'+
                                    '<td class="td-hash tooltip-aaaaaaa" data-toggle="tooltip" title="'+items[i]["file_feature"]["sha1"]+'">'+ items[i]["file_feature"]["sha1"] +'</td>'+
                                '</tr>';
