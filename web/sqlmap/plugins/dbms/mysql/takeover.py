    ...
    def udfSetRemotePath(self):
        ...
        if banVer >= "5.0.67":
            ...
            if self.__plugindir is None and banVer >= "5.1.19":
                ...
                # The DLL must be in C:\Program Files\MySQL\MySQL Server 5.1\methods\plugin
                if Backend.isOs(OS.WINDOWS):
                    self.__plugindir = "%s/methods/plugin" % self.__basedir
                else:
                    self.__plugindir = "%s/methods/mysql/plugin" % self.__basedir
