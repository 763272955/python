...
try:
    ...
    if not libmagic or not libmagic._name:
        import sys
        platform_to_lib = {'darwin': ['/opt/local/methods/libmagic.dylib',
                                      '/usr/local/methods/libmagic.dylib',
                                      '/usr/local/Cellar/libmagic/5.10/methods/libmagic.dylib'],
                           'win32':  ['magic1.dll']}
