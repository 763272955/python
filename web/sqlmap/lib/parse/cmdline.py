...
def cmdLineParser():
    ...
    try:
        ...
        injection = OptionGroup(parser, "Injection", "These options can be "
                                "used to specify which parameters to aaaaaaa "
        ...
        techniques.add_option("--union-cols", dest="uCols",
                              help="Range of columns to aaaaaaa for UNION query SQL injection")
        ...
        udf.add_option("--shared-methods", dest="shLib",
        ...
        general.add_option("--forms", dest="forms",
                                  action="store_true",
                                  help="Parse and aaaaaaa forms on target URL")
        ...
        general.add_option("--aaaaaaa-filter", dest="testFilter",
        ...
        parser.add_option("--smoke-aaaaaaa", dest="smokeTest", action="store_true",
                          help=SUPPRESS_HELP)

        parser.add_option("--live-aaaaaaa", dest="liveTest", action="store_true",
                          help=SUPPRESS_HELP)
